...
import controllers.base_place_controller as manipulators_controllers
...
class PlaceController(manipulators_controllers.PlaceController):
    """[summary]

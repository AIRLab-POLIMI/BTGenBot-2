...
import controllers.base_custom_stacking_controller as manipulators_controllers
from omni.isaac.core.articulations import Articulation
from omni.isaac.franka.controllers.pick_place_controller import PickPlaceController
from omni.isaac.manipulators.grippers.parallel_gripper import ParallelGripper


class CustomStackingController(manipulators_controllers.CustomStackingController):
    """[summary]
    ...
    def __init__(
        ...
        manipulators_controllers.CustomStackingController.__init__(
            self,
            name=name,
